...
lambda-layer-filepath        = "projects/cudl-data-processing/xslt/cudl-transform-xslt-0.0.6.zip"
...
transform-lambda-information = [
  {
    ...
    "jar_path"      = "release/uk/ac/cam/lib/cudl/awslambda/AWSLambda_Data_Transform/0.11/AWSLambda_Data_Transform-0.11-jar-with-dependencies.jar"
    "queue_name"    = "CUDLPackageDataQueue"
    "transcription" = false
    "timeout"       = 900
    "memory"        = 512
